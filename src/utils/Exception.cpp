...
Kusanagi::Utils::Exception::Exception(const std::string &message, const unsigned long code, const char* file, const unsigned long line) :
	c(code), msg(message), sourceFile(file), exceptionCausedLine(line) {}
