...
std::string Kusanagi::Utils::Format(const std::string fmt_str, ...) {
	int final_n, n = ((int)fmt_str.size()) * 2 + 512; /* Reserve two times as much as the length of the fmt_str */
...
std::wstring Kusanagi::Utils::Format(const std::wstring fmt_str, ...) {
	int final_n, n = ((int)fmt_str.size()) * 2 + 512; /* Reserve two times as much as the length of the fmt_str */
